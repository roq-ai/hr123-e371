...
export function EmployeeListPage(props: EmployeeListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getEmployees({
        relations: ['user', 'organization', 'performance_evaluation.count', 'team_member.count'],
  ...
  const columns: ColumnType[] = [
    { id: 'working_hours', header: 'working_hours', accessorKey: 'working_hours' },
    ...
    hasAccess('performance_evaluation', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          ...
          accessorKey: 'performance_evaluation',
          cell: ({ row: { original: record } }: any) => record?._count?.performance_evaluation,
        }
      : null,
